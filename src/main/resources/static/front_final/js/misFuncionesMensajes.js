...
function autoInicioMensajes(){
    ...
    $.ajax({
        url:"http://168.138.140.77:8080/api/Message/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
...
function guardarInformacionMensajes(){
    ...
    let var2 = {
        ...
        url:"http://168.138.140.77:8080/api/Message/save",
...
function actualizarInformacionMensaje(idElemento){
    ...
    $.ajax({
        url:"http://168.138.140.77:8080/api/Message/update",
        type:"PUT",
        data:dataToSend,
...
function borrarMensaje(idElemento){
    ...
    $.ajax({
        url:"http://168.138.140.77:8080/api/Message/"+idElemento,
        type:"DELETE",
        data:dataToSend,
        contentType:"application/JSON",
        datatype:"JSON",
